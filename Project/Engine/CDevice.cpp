...
int CDevice::CreateSwapChain()
{
	...
	Desc.BufferCount                        = 1;
	Desc.BufferDesc.Width                   = m_vResolution.x;             // 백버퍼 해상도 width
	Desc.BufferDesc.Height                  = m_vResolution.y;             // 백버퍼 해상도 height
...
{
	// ==================================================
	// RenderTarget Texture, DepthStencil Texture를 생성
	// ==================================================
...
int CDevice::CreateDepthStencilState()
{
	...
	// Less : 더 가까운 깊이일수록 통과(Default)
	m_DSState[(UINT)DS_TYPE::LESS] = nullptr;

	// Less Equal : 더 가깝거나 같은 깊이가 통과
